...
class GoodsCategory(models.Model):
    ...
    # help_text 选项 会在form表单控件中，接口文档中显示help文本
...
class GoodsCategoryBrand(models.Model):
    ...
    category = models.ForeignKey(GoodsCategory, related_name='brands', on_delete=False, null=True, blank=True,
                                 verbose_name="商品类目")
...
class Goods(models.Model):
    ...
    goods_front_image = models.ImageField(null=True, blank=True, upload_to="goods/images/", verbose_name="封面图")
...
class IndexAd(models.Model):
    category = models.ForeignKey(GoodsCategory, on_delete=False, related_name="category", verbose_name="商品类目")
    goods = models.ForeignKey(Goods, on_delete=False, related_name="goods")
